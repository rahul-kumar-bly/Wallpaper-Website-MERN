...
export default function WallpaperItem({wallpaper}) {
  return (
    <div className ="flex flex-col gap-2 w-[327px] h-[225px] justify-center">
      <div className='object-center w-[307px] h-[173px] hover:border-4 hover:scale-105 border-yellow-300 transition-scale overflow-hidden duration-300 ease-in-out self-center'>
      ...
      {wallpaper.width === 3840 && wallpaper.height === 2160 && (
          <span className='absolute bg-[#3e5749] text-white p-1 text-xs uppercase'>4K</span>
            ...
            {wallpaper.width === 2560 && wallpaper.height === 1440 && (
          <span className='absolute bg-[#3e5749] text-white p-1 text-xs uppercase'>2K</span>
      )}
